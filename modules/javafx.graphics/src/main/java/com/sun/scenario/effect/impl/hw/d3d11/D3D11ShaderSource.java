...
package com.sun.scenario.effect.impl.hw.d3d11;

import java.io.InputStream;
import com.sun.scenario.effect.Effect.AccelType;
import com.sun.scenario.effect.impl.hw.ShaderSource;

public class D3D11ShaderSource implements ShaderSource {

    public D3D11ShaderSource() {
    }

    public InputStream loadSource(String name) {
        return D3D11ShaderSource.class.
